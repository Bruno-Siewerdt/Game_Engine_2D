...
public class UI {
	...
	public void setState(GameState state) {
		if (Game.game.getState() == GameState.RUNNING) {
			...
			components.add(new Button("Continue", new Vector3(Game.WIDTH/2-200, Game.HEIGHT/2 - 150, 0), new Vector3(400, 100, 0), () -> {Game.game.setState(GameState.RUNNING);}));
			components.add(new Button("Continue", new Vector3(Game.WIDTH/2-200, Game.HEIGHT/2 +   0, 0), new Vector3(400, 100, 0), () -> {Game.game.setState(GameState.RUNNING);}));
